# Generated by Django 3.1.1 on 2020-11-13 19:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mastery_area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='src.masteryarea')),
            ],
        ),
        migrations.CreateModel(
            name='Page',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standard_user', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='src.standarduser')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_created', models.DateTimeField(auto_now_add=True, null=True)),
                ('pic', models.ImageField(blank=True, default='New.png', null=True, upload_to='')),
                ...
                ('standard_user_poster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='NetworkingVote',
